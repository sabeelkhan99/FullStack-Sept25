...
router.get('/profile', isLoggedIn,  async(req, res) => {
    ...
    res.json(ApiResponse.build(true, {username: user.username, email: user.email}, 'User profile details'));
})

router.get('/secret', isLoggedIn, (req, res) => {
    res.send('THIS IS SOME SECRET SHOULD NOT BE EXPOSED DIRECTLY');
});
